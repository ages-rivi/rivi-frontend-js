...
import MemberCardCarosel from 'old_src/components/Members/MemberCardCarosel';
import api from 'old_src/lib/api';
import { getSortedMembers } from 'old_src/pages/api/mock/members';
import { SortedMembers } from 'src/types/Member';
